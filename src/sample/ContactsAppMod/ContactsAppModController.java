package sample.ContactsAppMod;

import sample.ContactsAppMod.Student;
...
public class ContactsAppModController {
    ...
    public void initialize(){
        students.add(new Student("John", "Wick", "+1989234982398", "john@gmail.com","Economics", "sample.ContactsAppMod/Pictures/beknazar.jpg"));
        students.add(new Student("Mark", "Twain", "mark.twain@gmail.com", "+123123123123","Literature", "sample.ContactsAppModified/Pictures/naruto.jpg"));
